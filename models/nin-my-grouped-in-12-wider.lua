...
local function createModel(opt)
	...
	Block(192,384,1,1		,1,1,0,0	,12)
	Block(384,384,1,1		,1,1,0,0	,12)
	model:add(nn.SpatialMaxPooling(3,3,2,2):ceil())
	Block(384,768,5,5		,1,1,2,2	,12)
	Block(768,384,1,1		,1,1,0,0	,12)
	Block(384,384,1,1		,1,1,0,0	,12)
	model:add(nn.SpatialAveragePooling(3,3,2,2):ceil())

	Block(384,768,3,3		,1,1,1,1	,12)

	Block(768,384,1,1		,1,1,0,0	,1)
	Block(384,384,1,1		,1,1,0,0	,1)
