...
local function createModel(opt)
	...
	do
		...
		local nStages = torch.Tensor{24, 16*k, 32*k, 64*k}
		...
		model:add(layer(wide_basic, nStages[2], nStages[3], n, 2		,16)) -- Stage 2 (spatial size: 16x16)
		model:add(layer(wide_basic, nStages[3], nStages[4], n, 2		,16)) -- Stage 3 (spatial size: 8x8)
