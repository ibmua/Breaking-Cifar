...
local function createModel(opt)
	...
	do
		...
		model:add(layer(wide_basic, nStages[1], nStages[2], n, 1		,4)) -- Stage 1 (spatial size: 32x32)
		model:add(layer(wide_basic, nStages[2], nStages[3], n, 2		,4)) -- Stage 2 (spatial size: 16x16)
		model:add(layer(wide_basic, nStages[3], nStages[4], n, 2		,4)) -- Stage 3 (spatial size: 8x8)
