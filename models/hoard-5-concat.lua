...
function build	(
	...
	for	seq	=	1,	sequences	do
		...
		local	conv_params	=
				...
				{
					{
						{	ins		,	ins			,	2,2	,	1,1,	1,1	,	1	}
					,	{	ins		,	ins	* width	,	2,2	,	1,1,	0,0	,	1	}
					}
				}
		-- print(conv_params)
			...
			nn.Concat(2)
							...
							nn.Concat(2)
								...
								:add(
									nn.Sequential()
										...
										:add(
											nn.VolumetricMaxPooling(2,2,2, 2,2,2)
											)
										--4
										:add(
											nn.Concat(2)
				...
				:add(
					nn.Sequential()
						...
						:add(
							nn.SpatialAveragePooling(4,4, 4,4):ceil()
							)
					)
			)
		--1
		:add(
			nn.SpatialAveragePooling(4,4, 1,1):ceil()
			)
		:add(
