...
function build	(
	...
	for	seq	=	1,	sequences	do
		...
		local	conv_params_pool	=
										...
										,
											{
												{	ins			,	ins			,	1,5	,	1,1,	0,2	,	1		}
											,	{	ins			,	ins	*2		,	5,1	,	1,1,	2,0	,	1		}
											,	{	ins	*2		,	ins	*2		,	1,7	,	1,1,	0,3	,	1		}
											,	{	ins	*2		,	ins	/2		,	7,1	,	1,1,	3,0	,	1		}
											}
										,
											{
												{	ins			,	ins			,	1,1	,	1,1,	0,0	,	1		}
											,	{	ins			,	ins	*2		,	3,3	,	1,1,	1,1	,	1		}
											,	{	ins	*2		,	ins			,	3,3	,	1,1,	1,1	,	1		}
											}
										}
		-- print(conv_params)
