...
local function createModel(opt)
	...
	local function wide_basic(nInputPlane, nOutputPlane, stride	,	groups)
		...
		local conv_params =
			{
				{nInputPlane			,	nBottleneckPlane	*16	,	3,3	,	stride,stride,	1,1	,	nInputPlane			},
				{nBottleneckPlane	*16	,	nBottleneckPlane		,	1,1	,	1,1,			0,0	,	nBottleneckPlane/2	},
				{nBottleneckPlane		,	nBottleneckPlane	*16	,	3,3	,	1,1,			1,1	,	nBottleneckPlane	},
				{nBottleneckPlane	*16	,	nOutputPlane			,	1,1	,	1,1,			0,0	,	nBottleneckPlane/4	},
			}
