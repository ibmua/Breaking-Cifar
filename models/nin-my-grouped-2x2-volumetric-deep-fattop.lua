...
local function createModel(opt)
	...
	Block(3,32,		2,2,1,1,1,1				,1)
	Block(32,256,	2,2,1,1,0,0				,1)

	Block(256,512,	2,2,1,1,1,1				,2)
	Block(512,512,	2,2,1,1,0,0				,32)
	Block(512,512,	2,2,1,1,1,1				,4)
	Block(512,512,	2,2,1,1,0,0				,32)
	Block(512,512,	2,2,1,1,1,1				,2)
	Block(512,256,	2,2,1,1,0,0				,32)

	Block(256,128,	2,2,1,1,1,1				,1)
	Block(128,256,	2,2,1,1,0,0				,1)
	...
	Block(1024,1024,	2,2,1,1,1,1				,4)
	Block(1024,1024,	2,2,1,1,0,0				,8)
	Block(1024,1024,	2,2,1,1,1,1				,4)
	Block(1024,1024,	2,2,1,1,0,0				,8)
	...
	Block(2048,2048,2,2		,1,1,1,1	,4)
	Block(2048,2048,2,2		,1,1,0,0	,8)
	Block(2048,2048,2,2		,1,1,1,1	,4)
	Block(2048,2048,2,2		,1,1,0,0	,8)
