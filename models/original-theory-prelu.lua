...
local function createModel(opt)
	...
	local function wide_basic(nInputPlane, nOutputPlane, stride	,	groups)
		...
		local conv_params =
			{
				{nInputPlane			,	nBottleneckPlane	*8	,	3,3	,	stride,stride,	1,1	,	nInputPlane			},
				{nBottleneckPlane	*8	,	nBottleneckPlane		,	1,1	,	1,1,			0,0	,	1					},
				{nBottleneckPlane		,	nBottleneckPlane	*8	,	3,3	,	1,1,			1,1	,	nBottleneckPlane	},
				{nBottleneckPlane	*8	,	nOutputPlane			,	1,1	,	1,1,			0,0	,	1					},
			}
