...
local function createModel(opt)
	...
	Block(32,64,	2,2,1,1,0,0				,1)
	Block(64,128,	2,2,1,1,1,1				,4)
	Block(128,256,	2,2,1,1,0,0				,8)
	...
	Block(128,128,	2,2,1,1,0,0				,4)
	Block(128,512,	2,2,1,1,1,1				,16)
	Block(512,512,	2,2,1,1,0,0				,16)


	-- Block(96,192,5,5		,1,1,2,2	,3)
	-- Block(192,192,1,1		,1,1,0,0	,3)
	Block(512,256,1,1		,1,1,0,0	,2)
	model:add(nn.SpatialAveragePooling(3,3,2,2):ceil())

	Block(256,256,2,2		,1,1,1,1	,4)
	Block(256,256,2,2		,1,1,0,0	,8)
