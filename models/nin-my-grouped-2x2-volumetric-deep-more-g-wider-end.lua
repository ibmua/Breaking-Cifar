...
local function createModel(opt)
	...
	Block(32,128,	2,2,1,1,0,0				,1)

	Block(128,128,	2,2,1,1,1,1				,16)
	Block(128,128,	2,2,1,1,0,0				,8)
	Block(128,128,	2,2,1,1,1,1				,16)
	Block(128,128,	2,2,1,1,0,0				,8)
	Block(128,128,	2,2,1,1,1,1				,16)
	Block(128,128,	2,2,1,1,0,0				,8)
	...
	Block(1024,1024,	2,2,1,1,1,1				,32)
	Block(1024,1024,	2,2,1,1,0,0				,128)
	...
	Block(2048,2048,2,2		,1,1,1,1	,256)
	Block(2048,2048,2,2		,1,1,0,0	,128)
	Block(2048,2048,2,2		,1,1,1,1	,4)
	Block(2048,4096,2,2		,1,1,0,0	,256)

	-- Block(192,192,1,1		,1,1,0,0	,1)
	Block(4096,2048,1,1		,1,1,0,0	,1)
