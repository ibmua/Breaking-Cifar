...
local function createModel(opt)
	...
	Block(48,192,1,1		,1,1,0,0	,12)

	Block(192,96,1,1		,1,1,0,0	,12)
	Block(96,48	,1,1		,1,1,0,0	,12)

	Block(48,48	,1,1		,1,1,0,0	,1)

	model:add(nn.SpatialMaxPooling(3,3,2,2):ceil())

	Block(48,192,5,5		,1,1,2,2	,12)

	Block(192,768,1,1		,1,1,0,0	,24)
	Block(768,384,1,1		,1,1,0,0	,24)
	Block(384,192,1,1		,1,1,0,0	,24)

	Block(192,192,1,1		,1,1,0,0	,1)

	model:add(nn.SpatialAveragePooling(3,3,2,2):ceil())

	Block(192,768,3,3		,1,1,1,1	,24)

	Block(768,3072	,1,1	,1,1,0,0	,24)
	Block(3072,1536	,1,1	,1,1,0,0	,24)
	Block(1536,768	,1,1	,1,1,0,0	,24)
