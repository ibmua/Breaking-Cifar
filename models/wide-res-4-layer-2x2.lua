...
local function createModel(opt)
	...
	local function wide_basic(nInputPlane, nOutputPlane, stride	,	groups)
		...
		local conv_params =
			{
				{nInputPlane			,	nBottleneckPlane		,	2,2	,	stride,stride,	1,1	,	1			},
				{nBottleneckPlane		,	nBottleneckPlane		,	2,2	,	1,1,			0,0	,	1			},
				{nBottleneckPlane		,	nOutputPlane			,	2,2	,	1,1,			1,1	,	1			},
				{nBottleneckPlane		,	nOutputPlane			,	2,2	,	1,1,			0,0	,	1			},
			}
